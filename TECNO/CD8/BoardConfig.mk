...
TARGET_CPU_VARIANT_RUNTIME := cortex-a53
ARGET_CPU_ABI_LIST_64_BIT := $(TARGET_CPU_ABI)
...
BOARD_CACHEIMAGE_PARTITION_SIZE := 274590000
BOARD_SYSTEMIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 3600000000
BOARD_VENDORIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_VENDORIMAGE_PARTITION_SIZE := 510220000
BOARD_USERDATAIMAGE_FILE_SYSTEM_TYPE := ext4
BOARD_USERDATAIMAGE_PARTITION_SIZE := 111150000000
...
SHRP_DEVICE_CODE := CD8-H655B-RU
SHRP_MAINTAINER := DIMONNEMO-DL
SHRP_REC_TYPE := Treble
SHRP_PATH := device/TECNO/CD8
